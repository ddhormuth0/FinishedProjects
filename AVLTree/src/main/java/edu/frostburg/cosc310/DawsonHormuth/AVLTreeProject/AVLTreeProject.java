 ...
 *
 * This interface declares required methods for this project. When your project
 * begins execution, it should create a new instance of your version of this
 * class. This class will refer to your AVL Tree to complete its associated
 * methods. You must implement all of these methods, but you may also implement
 * any other methods that you find useful.
 *
 * @author Steve K
 *
 */
public interface AVLTreeProject {
    ...
    /* AVL Tree stuff ----------------- */
    /**
     * Insert a new item into your AVL Tree. Since the data is all Strings, we
     * can stick to that type.
     *
     * @param name The key value
     * @param interests An list of 0 or more interests.
     */
